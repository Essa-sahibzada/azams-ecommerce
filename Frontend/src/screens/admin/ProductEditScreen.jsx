        ...
        <div style={{ marginBottom: '40px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div>
            ...
            <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '42px', fontWeight: 300, color: '#1A1A18', margin: 0 }}>
              Edit <em style={{ fontStyle: 'italic', color: '#C9A96E' }}>Product</em>
            </h1>
          </div>
              ...
              <div style={{ display: 'flex', gap: '32px', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      textTransform: 'uppercase', backgroundColor: saving ? '#8C8478' : '#1A1A18',
                ...
                <div style={{ width: '280px', flexShrink: 0 }}>
                  ...
                  <div style={{ width: '100%', paddingTop: '133%', position: 'relative', backgroundColor: '#E8E2D8', overflow: 'hidden' }}>
                    {image ? (
                      ...
                      <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <p style={{ fontSize: '8px', letterSpacing: '2px', textTransform: 'uppercase', color: '#C4BFB8' }}>No Image</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{ marginTop: '16px', padding: '16px', backgroundColor: 'white', borderTop: '2px solid #C9A96E' }}>
                    <p style={{ fontSize: '8px', letterSpacing: '2px', textTransform: 'uppercase', color: '#8C8478', marginBottom: '4px' }}>{category || '—'}</p>
                    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '18px', fontWeight: 300, color: '#1A1A18', marginBottom: '4px' }}>{name || '—'}</p>
                    <p style={{ fontSize: '12px', color: '#C9A96E' }}>Rs. {Number(price).toLocaleString() || '0'}</p>
                    <p style={{ fontSize: '10px', color: countInStock > 5 ? '#22c55e' : countInStock > 0 ? '#f59e0b' : '#ef4444', marginTop: '4px' }}>
                      Stock: {countInStock}
                    </p>
                  </div>
                </div>
